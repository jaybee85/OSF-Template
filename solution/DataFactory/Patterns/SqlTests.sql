...
delete from [dbo].[TaskInstance] where taskmasterid <=0;
    ...
    select 
        -33                          ,
        '[-33]  WatermarkCDC of SalesLT.Customer (Table) from SQL Server to SalesLT.Customer.parquet in Azure Blob(Parquet)'                      ,
        -4                            ,
        -2                           ,
        -4                      ,
        -14                        ,
    ...
    "Target": {
        "DataFileName": "SalesLT.Customer.parquet",
        "RelativePath": "/Tests/SQL Database to Azure Storage CDC/-33",
        "SchemaFileName": "SalesLT.Customer.json",
        "Type": "Parquet"
    }
}'                      ,
    ...
    select 
        -34                          ,
        '[-32]  WatermarkCDC of SalesLT.Customer (Table) from SQL Server to SalesLT.Customer.parquet in ADLS(Parquet)'                      ,
        -4                            ,
        -2                           ,
        -4                      ,
        -14                        ,
    ...
    "Target": {
        "DataFileName": "SalesLT.Customer.parquet",
        "RelativePath": "/Tests/SQL Database to Azure Storage CDC/-32",
        "SchemaFileName": "SalesLT.Customer.json",
        "Type": "Parquet"
    }
}'                      ,
