declare @path varchar(200)= 'samples/sif'+'/StudentScoreJudgementAgainstStandard/StudentScoreJudgementAgainstStandard/Snapshot/StudentScoreJudgementAgainstStandard/*'
