...
INSERT [dbo].[SourceAndTargetSystems] ([SystemId], [SystemName], [SystemType], [SystemDescription], [SystemServer], [SystemAuthType], [SystemUserName], [SystemSecretName], [SystemKeyVaultBaseUrl], [SystemJSON], [ActiveYN], [DataFactoryIR])

VALUES (15, N'Sample - File Server ', N'FileServer', N'Sample File Server Source', N'(local)', N'MSI', NULL, NULL, N'https://$KeyVaultName$.vault.azure.net/', N'', 1, '')
