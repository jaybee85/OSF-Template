remote_state {
  ...
  config = {
    ...
    resource_group_name  = "dlzdev05"
    storage_account_name = "dlzdev05state"
...
inputs = {
  ...
  subscription_id                       = "8cc117a4-d03d-4a14-a905-3b6dd744829c"     # The azure subscription id to deploy to
