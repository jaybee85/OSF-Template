inputs = {
  ...
  resource_group_name                   = "gf1"          # The resource group all resources will be deployed to
  ...
  ip_address                            = "223.27.193.69"          # This is the ip address of the agent/current IP. Used to create firewall exemptions.
